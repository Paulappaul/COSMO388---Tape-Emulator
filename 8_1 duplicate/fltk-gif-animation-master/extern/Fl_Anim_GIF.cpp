...
#define _CRT_SECURE_NO_WARNINGS // Add this to suppress warnings related to deprecated functions
#define strdup _strdup // Define a macro to map strdup to _strdup
